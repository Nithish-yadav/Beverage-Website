      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            Origin Energy is a better-for-you energy drink crafted with natural flavors, zero sugar, and a clean energy
        ...
        >
          ...
          >
            <span className="text-xl font-black">
              ...
              <span className="text-[#AFFF00]">gin</span>
            </span>
          </motion.div>

          <p className="text-white/40 font-mono text-xs">© 2026 Origin Energy. All rights reserved.</p>
