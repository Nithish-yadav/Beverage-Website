...
const lifestyleImages = [
  { src: "/images/lifestyle-professional.jpg", alt: "Professional working late night", aspect: "portrait" },
  { src: "/images/lifestyle-gym.jpg", alt: "Athlete fitness workout", aspect: "landscape" },
  { src: "/images/lifestyle-creator.jpg", alt: "Content creator streaming setup", aspect: "square" },
  { src: "/images/lifestyle-student.jpg", alt: "Student studying late night", aspect: "landscape" },
  { src: "/images/lifestyle-skater.jpg", alt: "Skateboarder urban street", aspect: "portrait" },
  { src: "/images/lifestyle-entrepreneur.jpg", alt: "Entrepreneur startup meeting", aspect: "square" },
]

const socialPosts = [
  { handle: "@creativekatie", text: "Origin got me through my entire album production. No cap 🔥", likes: "2.4k" },
